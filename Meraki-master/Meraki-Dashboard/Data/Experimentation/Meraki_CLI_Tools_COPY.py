...
import getpass
#######################################################################################################################################
# DEFINE ALL CLASSESS BELOW THIS LINE                                                                                                 #
#######################################################################################################################################
class Organization:
...
class Admin:
	# Initializer / Instance Attributes	
	def __init__(self, name, email, admin_id, networks, tags, twoFactorAuthEnabled, lastActive, accountStatus, hasApiKey, orgAccess):
		self.name = name
		self.email = email
